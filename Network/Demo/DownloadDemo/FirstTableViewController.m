...
- (void)viewDidLoad {
    ...
    self.urlArr = @[@"https://dl.devmate.com/com.macpaw.CleanMyMac3/CleanMyMac3.dmg",@"https://dl.devmate.com/com.macpaw.CleanMyMac3/CleanMyMac3.dmg",@"https://dl.devmate.com/com.macpaw.CleanMyMac3/CleanMyMac3.dmg",@"https://dl.devmate.com/com.macpaw.CleanMyMac3/CleanMyMac3.dmg"];
    self.titleArr = @[@"李白_李荣浩",@"李荣浩_不将就",@"张碧晨_年轮 ",@"王菲_匆匆那年"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    [DDownloadCenter addTaskSaveName:self.titleArr[indexPath.row] urlStr:self.urlArr[indexPath.row] flag:@"标签" duration:@"接口" backType:^(DownloadBackType type) {
        if (type == Finish) {
            NSLog(@"添加成功");
        }else{
            NSLog(@"任务存在");
