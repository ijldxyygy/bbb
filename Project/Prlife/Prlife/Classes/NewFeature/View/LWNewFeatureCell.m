...
@implementation LWNewFeatureCell
...
- (UIButton *)startButton
{
    if (_startButton == nil) {
        ...
        [startBtn setTitle:@"开始应用" forState:UIControlStateNormal];
...
{
    // 进入tabBarVc
//    LWTabBarController *tabBarVc = [[CZTabBarController alloc] init];
    
    // 切换根控制器:可以直接把之前的根控制器清空
//    LWKeyWindow.rootViewController = tabBarVc;
