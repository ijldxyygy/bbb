...
#import "LWNewFeatureCell.h"

@interface LWNewFeatureController ()
...
- (void)viewDidLoad {
    ...
    [self.collectionView registerClass:[LWNewFeatureCell class] forCellWithReuseIdentifier:ID];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // 3.没有注册，报错
    LWNewFeatureCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ID forIndexPath:indexPath];
